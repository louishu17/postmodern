...
public class SoldierPathing extends BFS {

    public SoldierPathing(RobotController rc) {
        super(rc);
    }
    ...
    public Direction bestDir(MapLocation target){
        try {
            l112 = rc.getLocation();
            d112 = 0;
            ...
            if (rc.canSenseLocation(l111) && rc.senseMapInfo(l111).isPassable() && checkCurrent(Direction.WEST, rc.senseMapInfo(l111).getCurrentDirection())) { // check (-1, 0)
            ...
            if (rc.canSenseLocation(l97) && rc.senseMapInfo(l97).isPassable() && checkCurrent(Direction.SOUTH, rc.senseMapInfo(l97).getCurrentDirection())) { // check (0, -1)
            ...
            if (rc.canSenseLocation(l127) && rc.senseMapInfo(l127).isPassable() && checkCurrent(Direction.NORTH, rc.senseMapInfo(l127).getCurrentDirection())) { // check (0, 1)
            ...
            if (rc.canSenseLocation(l113) && rc.senseMapInfo(l113).isPassable() && checkCurrent(Direction.EAST, rc.senseMapInfo(l113).getCurrentDirection())) { // check (1, 0)
            ...
            if (rc.canSenseLocation(l96) && rc.senseMapInfo(l96).isPassable()&& checkCurrent(Direction.SOUTHWEST, rc.senseMapInfo(l96).getCurrentDirection())) { // check (-1, -1)
            ...
            if (rc.canSenseLocation(l126) && rc.senseMapInfo(l126).isPassable()&& checkCurrent(Direction.NORTHWEST, rc.senseMapInfo(l126).getCurrentDirection())) { // check (-1, 1)
            ...
            if (rc.canSenseLocation(l98) && rc.senseMapInfo(l98).isPassable()&& checkCurrent(Direction.SOUTHEAST, rc.senseMapInfo(l98).getCurrentDirection())) { // check (1, -1)
            ...
            if (rc.canSenseLocation(l128) && rc.senseMapInfo(l128).isPassable()&& checkCurrent(Direction.NORTHEAST, rc.senseMapInfo(l128).getCurrentDirection())) { // check (1, 1)
            ...
            if (rc.canSenseLocation(l110) && rc.senseMapInfo(l110).isPassable()) { // check (-2, 0)
            ...
            if (rc.canSenseLocation(l82) && rc.senseMapInfo(l82).isPassable()) { // check (0, -2)
                if (d82 > d97) { // from (0, -1)
                    d82 = d97;
                    dir82 = dir97;
                }
            ...
            if (rc.canSenseLocation(l142) && rc.senseMapInfo(l142).isPassable()) { // check (0, 2)
            ...
            if (rc.canSenseLocation(l114) && rc.senseMapInfo(l114).isPassable()) { // check (2, 0)
            ...
            if (rc.canSenseLocation(l95) && rc.senseMapInfo(l95).isPassable()) { // check (-2, -1)
            ...
            if (rc.canSenseLocation(l125) && rc.senseMapInfo(l125).isPassable()) { // check (-2, 1)
            ...
            if (rc.canSenseLocation(l81) && rc.senseMapInfo(l81).isPassable()) { // check (-1, -2)
                if (d81 > d97) { // from (0, -1)
                    d81 = d97;
                    dir81 = dir97;
                }
            ...
            if (rc.canSenseLocation(l141) && rc.senseMapInfo(l141).isPassable()) { // check (-1, 2)
            ...
            if (rc.canSenseLocation(l83) && rc.senseMapInfo(l83).isPassable()) { // check (1, -2)
                if (d83 > d97) { // from (0, -1)
                    d83 = d97;
                    dir83 = dir97;
                }
            ...
            if (rc.canSenseLocation(l143) && rc.senseMapInfo(l143).isPassable()) { // check (1, 2)
            ...
            if (rc.canSenseLocation(l99) && rc.senseMapInfo(l99).isPassable()) { // check (2, -1)
            ...
            if (rc.canSenseLocation(l129) && rc.senseMapInfo(l129).isPassable()) { // check (2, 1)
            ...
            if (rc.canSenseLocation(l80) && rc.senseMapInfo(l80).isPassable()) { // check (-2, -2)
                if (d80 > d96) { // from (-1, -1)
                    d80 = d96;
                    dir80 = dir96;
                }
            ...
            if (rc.canSenseLocation(l140) && rc.senseMapInfo(l140).isPassable()) { // check (-2, 2)
            ...
            if (rc.canSenseLocation(l84) && rc.senseMapInfo(l84).isPassable()) { // check (2, -2)
                if (d84 > d98) { // from (1, -1)
                    d84 = d98;
                    dir84 = dir98;
                }
            ...
            if (rc.canSenseLocation(l144) && rc.senseMapInfo(l144).isPassable()) { // check (2, 2)
            ...
            if (rc.canSenseLocation(l109) && rc.senseMapInfo(l109).isPassable()) { // check (-3, 0)
            ...
            if (rc.canSenseLocation(l67) && rc.senseMapInfo(l67).isPassable()) { // check (0, -3)
                if (d67 > d82) { // from (0, -2)
                    d67 = d82;
                    dir67 = dir82;
                }
            ...
            if (rc.canSenseLocation(l157) && rc.senseMapInfo(l157).isPassable()) { // check (0, 3)
            ...
            if (rc.canSenseLocation(l115) && rc.senseMapInfo(l115).isPassable()) { // check (3, 0)
            ...
            if (rc.canSenseLocation(l94) && rc.senseMapInfo(l94).isPassable()) { // check (-3, -1)
            ...
            if (rc.canSenseLocation(l124) && rc.senseMapInfo(l124).isPassable()) { // check (-3, 1)
            ...
            if (rc.canSenseLocation(l66) && rc.senseMapInfo(l66).isPassable()) { // check (-1, -3)
                if (d66 > d82) { // from (0, -2)
                    d66 = d82;
                    dir66 = dir82;
                }
            ...
            if (rc.canSenseLocation(l156) && rc.senseMapInfo(l156).isPassable()) { // check (-1, 3)
            ...
            if (rc.canSenseLocation(l68) && rc.senseMapInfo(l68).isPassable()) { // check (1, -3)
                if (d68 > d82) { // from (0, -2)
                    d68 = d82;
                    dir68 = dir82;
                }
            ...
            if (rc.canSenseLocation(l158) && rc.senseMapInfo(l158).isPassable()) { // check (1, 3)
            ...
            if (rc.canSenseLocation(l100) && rc.senseMapInfo(l100).isPassable()) { // check (3, -1)
            ...
            if (rc.canSenseLocation(l130) && rc.senseMapInfo(l130).isPassable()) { // check (3, 1)
            ...
            if (rc.canSenseLocation(l79) && rc.senseMapInfo(l79).isPassable()) { // check (-3, -2)
                if (d79 > d95) { // from (-2, -1)
                    d79 = d95;
                    dir79 = dir95;
                }
            ...
            if (rc.canSenseLocation(l139) && rc.senseMapInfo(l139).isPassable()) { // check (-3, 2)
            ...
            if (rc.canSenseLocation(l65) && rc.senseMapInfo(l65).isPassable()) { // check (-2, -3)
                if (d65 > d81) { // from (-1, -2)
                    d65 = d81;
                    dir65 = dir81;
                }
            ...
            if (rc.canSenseLocation(l155) && rc.senseMapInfo(l155).isPassable()) { // check (-2, 3)
            ...
            if (rc.canSenseLocation(l69) && rc.senseMapInfo(l69).isPassable()) { // check (2, -3)
                if (d69 > d83) { // from (1, -2)
                    d69 = d83;
                    dir69 = dir83;
                }
            ...
            if (rc.canSenseLocation(l159) && rc.senseMapInfo(l159).isPassable()) { // check (2, 3)
            ...
            if (rc.canSenseLocation(l85) && rc.senseMapInfo(l85).isPassable()) { // check (3, -2)
                if (d85 > d99) { // from (2, -1)
                    d85 = d99;
                    dir85 = dir99;
                }
            ...
            if (rc.canSenseLocation(l145) && rc.senseMapInfo(l145).isPassable()) { // check (3, 2)
            ...
            if (rc.canSenseLocation(l108) && rc.senseMapInfo(l108).isPassable()) { // check (-4, 0)
            ...
            if (rc.canSenseLocation(l52) && rc.senseMapInfo(l52).isPassable()) { // check (0, -4)
                if (d52 > d67) { // from (0, -3)
                    d52 = d67;
                    dir52 = dir67;
                }
            ...
            if (rc.canSenseLocation(l172) && rc.senseMapInfo(l172).isPassable()) { // check (0, 4)
            ...
            if (rc.canSenseLocation(l116) && rc.senseMapInfo(l116).isPassable()) { // check (4, 0)
            ...
            if (rc.canSenseLocation(l93) && rc.senseMapInfo(l93).isPassable()) { // check (-4, -1)
            ...
            if (rc.canSenseLocation(l123) && rc.senseMapInfo(l123).isPassable()) { // check (-4, 1)
            ...
            if (rc.canSenseLocation(l51) && rc.senseMapInfo(l51).isPassable()) { // check (-1, -4)
                if (d51 > d67) { // from (0, -3)
                    d51 = d67;
                    dir51 = dir67;
                }
            ...
            if (rc.canSenseLocation(l171) && rc.senseMapInfo(l171).isPassable()) { // check (-1, 4)
            ...
            if (rc.canSenseLocation(l53) && rc.senseMapInfo(l53).isPassable()) { // check (1, -4)
                if (d53 > d67) { // from (0, -3)
                    d53 = d67;
                    dir53 = dir67;
                }
            ...
            if (rc.canSenseLocation(l173) && rc.senseMapInfo(l173).isPassable()) { // check (1, 4)
            ...
            if (rc.canSenseLocation(l101) && rc.senseMapInfo(l101).isPassable()) { // check (4, -1)
            ...
            if (rc.canSenseLocation(l131) && rc.senseMapInfo(l131).isPassable()) { // check (4, 1)
            ...
            if (rc.canSenseLocation(l64) && rc.senseMapInfo(l64).isPassable()) { // check (-3, -3)
                if (d64 > d80) { // from (-2, -2)
                    d64 = d80;
                    dir64 = dir80;
                }
            ...
            if (rc.canSenseLocation(l154) && rc.senseMapInfo(l154).isPassable()) { // check (-3, 3)
            ...
            if (rc.canSenseLocation(l70) && rc.senseMapInfo(l70).isPassable()) { // check (3, -3)
                if (d70 > d84) { // from (2, -2)
                    d70 = d84;
                    dir70 = dir84;
                }
            ...
            if (rc.canSenseLocation(l160) && rc.senseMapInfo(l160).isPassable()) { // check (3, 3)
            ...
            if (rc.canSenseLocation(l78) && rc.senseMapInfo(l78).isPassable()) { // check (-4, -2)
                if (d78 > d94) { // from (-3, -1)
                    d78 = d94;
                    dir78 = dir94;
                }
            ...
            if (rc.canSenseLocation(l138) && rc.senseMapInfo(l138).isPassable()) { // check (-4, 2)
            ...
            if (rc.canSenseLocation(l50) && rc.senseMapInfo(l50).isPassable()) { // check (-2, -4)
                if (d50 > d66) { // from (-1, -3)
                    d50 = d66;
                    dir50 = dir66;
                }
            ...
            if (rc.canSenseLocation(l170) && rc.senseMapInfo(l170).isPassable()) { // check (-2, 4)
            ...
            if (rc.canSenseLocation(l54) && rc.senseMapInfo(l54).isPassable()) { // check (2, -4)
                if (d54 > d68) { // from (1, -3)
                    d54 = d68;
                    dir54 = dir68;
                }
            ...
            if (rc.canSenseLocation(l174) && rc.senseMapInfo(l174).isPassable()) { // check (2, 4)
            ...
            if (rc.canSenseLocation(l86) && rc.senseMapInfo(l86).isPassable()) { // check (4, -2)
            ...
            if (rc.canSenseLocation(l146) && rc.senseMapInfo(l146).isPassable()) { // check (4, 2)
